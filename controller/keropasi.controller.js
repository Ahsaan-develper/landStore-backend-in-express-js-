...
export const register_keropasi = async (req, res) => {
    try {
        const { fullname, email, password, phone_number, country_phone_code, IC, entity_type  , koperasi_name , koperasi_reg_number } = req.body;
