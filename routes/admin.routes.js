...
import { user_login_validator, user_profile_id_validator, user_register_validator } from "../middleware/validators/auth.validator.js";
...
admin_router.get("/" , user_login_validator , HandleValidationError , admin_login )

// get every user profile 

admin_router.get("/every_profile" , verify_token , authorize("super_admin") , user_profile_id_validator , HandleValidationError , get_user_by_admin_profile)

// get all users detail

admin_router.get("/every_user" , verify_token , authorize("super_admin" , "user_admin") , get_all_users);
...
admin_router.patch("/change_role" , verify_token , authorize("super_admin")  , admin_change_role_validator , HandleValidationError, change_admin_role_by_super_admin);