...
import { upload_profile_to_multer } from "../middleware/multer.middleware.js";
...
auth_router.patch("/:user_id" , verify_token, update_user_validator , HandleValidationError , upload_profile_to_multer,update_user);
