...
import { company_register_validator, Koperasi_register_validator, password_validator, update_user_validator, user_detail_validator, user_id_validator, user_login_validator, user_profile_id_validator, user_register_validator } from "../middleware/validators/auth.validator.js";
...
auth_router.patch("/reset_new_password" , password_validator , HandleValidationError  , reset_password);
// verify email
...
auth_router.delete("/" , verify_token,  delete_user);
