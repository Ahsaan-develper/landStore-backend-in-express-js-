...
import { register_company } from "../controller/company.controller.js";
...
company_router.post("/", checkDuplicates , validateRegister  , handleUserAuthError  , register_company )

// login company 

company_router.get("/" , login_user_validation , handleUserAuthError , login_user);

// update an company 

company_router.patch("/:id" , verify_token , authorize("admin" , "company") , upload_file_to_multer.single("img") , params_news_validator , handleUserAuthError , update_user);

// delete an company

company_router.delete("/:id" , verify_token , authorize("admin" , "company") , params_news_validator , handleUserAuthError, delete_user);