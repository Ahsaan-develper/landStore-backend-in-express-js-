...
import { change_enquiry_status, create_enquiry, get_all_enquiry, get_all_enquiry_by_admin, get_geran_docs_by_enquiry, get_single_enquiry } from "../controller/enquiry.controller.js";
...
enquiry_router.patch("/enquiry_status_user/:enquiry_id" , verify_token , authorize("individual" , "company" , "keporasi")    , change_enquiry_status_by_user_validator , HandleValidationError , change_enquiry_status)
