...
// create listing 
listing_router.post("/" , verify_token ,authorize("individual" , "company" , "koperasi")  , upload_listing_to_multer , create_listing_validator , HandleValidationError, create_listing);

// make an draft 

listing_router.post("/draft" , verify_token ,authorize("individual" , "company" , "koperasi") , upload_listing_to_multer , make_draft_by_user)
...
listing_router.get("/all_under_review" , verify_token,authorize("individual" , "company" , "koperasi") , listing_page_validator , HandleValidationError, get_under_review_listings )

// all active listings 
listing_router.get("/all_active" , verify_token , authorize("individual" , "company" , "koperasi") , listing_page_validator , HandleValidationError , get_active_listings)

// get all in active listingss 
listing_router.get("/all_inactive" , verify_token , authorize("individual" , "company" , "koperasi") , listing_page_validator , HandleValidationError , get_inactive_listings)
// get all pending listings
listing_router.get("/all_pending" , verify_token , authorize("individual" , "company" , "koperasi") , listing_page_validator , HandleValidationError , get_pending_listings)
...
listing_router.get("/total_count" , verify_token,authorize("individual" , "company" , "koperasi") , get_all_views_count)
...
// delete an listing
listing_router.delete("/deactived/:id" , verify_token  ,authorize("individual" , "company" , "koperasi") , listing_id_validator, HandleValidationError , deactivate_listing )


// update an listing 
listing_router.patch("/:id" , verify_token  ,authorize("individual" , "company" , "koperasi") , listing_id_validator  , upload_listing_to_multer ,  update_listing_validator , HandleValidationError , update_listing )

// punlished an listing 
listing_router.patch("/published/:id" , verify_token  ,authorize("individual" , "company" , "koperasi") , listing_id_validator  , HandleValidationError , publish_listing )
