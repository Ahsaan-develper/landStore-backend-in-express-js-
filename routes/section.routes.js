...
import { create_browse_map_content, create_button, create_category, create_container, create_footer_content, create_menu_card, create_news, create_section, create_statistic_card, create_statistic_content, create_testimonial_card, get_all_section, get_browse_content, get_button, get_container, get_footer_content, get_news_content, get_news_section, get_reviews_content, get_single_cards, get_single_news_detail, get_single_testimonial_card, get_statistic_content, get_testimonial_content, section_active_inactive, single_menu_card, single_news_category_all_cards } from "../controller/section.controller.js";
...
section_router.get("/news_section" , verify_token, authorize("super_admin" , "section_admin") , section_query_id_validator , HandleValidationError , get_news_section  )
