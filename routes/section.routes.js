...
import { update_news_category_validator, update_testimonial_card_validator, update_menu_card_validator, card_style_update_validator , news_card_update_validator , card_icon_update_validator , card_data_update_validator, update_statistic_content_validator,  update_button_validator, card_data_validator, card_icon_validator, card_style_validator, create_button_validator, create_container_validator, create_menu_card_validator, create_news_category_validator, create_section_validator, create_statistic_card_validator, create_statistic_content_validator, create_testimonial_card_validator, news_card_validator, section_id_validator, section_padding_validator, section_query_id_validator, section_padding_update_validator, update_container_validator } from "../middleware/validators/section.validator.js";
...
// create hero section state header section 
section_router.post("/hero_section/:section_id", verify_token, authorize("super_admin", "section_admin"), upload_img_to_multer, section_id_validator, card_data_validator, HandleValidationError, create_header_section)
...
section_router.patch("/section_status_toggle/:section_id", verify_token, authorize("super_admin", "section_admin"), section_id_validator, HandleValidationError, section_active_inactive)

// update the container
section_router.patch("/container/:section_id", verify_token, authorize("super_admin", "section_admin"), section_id_validator, update_container_validator, section_padding_update_validator, HandleValidationError, state_container_data_updated)

// updated button
section_router.patch("/button/:section_id", verify_token, authorize("super_admin", "section_admin"), section_id_validator, update_button_validator , section_padding_update_validator, HandleValidationError, update_button)

// update the content
section_router.patch("/content/:section_id", verify_token, authorize("super_admin", "section_admin"), upload_image_video, section_id_validator , update_statistic_content_validator,section_padding_update_validator , card_data_update_validator, HandleValidationError, content_statistic_update)

// update content for just footer sections
section_router.patch("/footer/:section_id", verify_token, authorize("super_admin", "section_admin"), upload_footer_logo_to_multer, section_id_validator , update_statistic_content_validator, HandleValidationError, content_statistic_update)

// update the statistic card update
section_router.patch("/card_update/:section_id", verify_token, authorize("super_admin", "section_admin"), upload_img_to_multer, section_id_validator , section_padding_update_validator , card_style_update_validator , card_data_update_validator , news_card_update_validator , card_icon_update_validator, HandleValidationError, statistic_card_update)

// update menu card
section_router.patch("/menu_card_update/:section_id", verify_token, authorize("super_admin", "section_admin"), section_id_validator , section_padding_update_validator , card_style_update_validator , update_menu_card_validator, HandleValidationError, update_menu_card)

// update testimonial cards data
section_router.patch("/testimonial_card_update/:section_id", verify_token, authorize("super_admin", "section_admin"), section_id_validator  , section_padding_update_validator , update_testimonial_card_validator, card_style_update_validator, HandleValidationError, update_testimonial_card)

// update category name
section_router.patch("/category_name_update/:section_id", verify_token, authorize("super_admin", "section_admin"), section_id_validator , update_news_category_validator, HandleValidationError, update_card_category_name)

// delete the card
section_router.delete("/delete_card/:section_id", verify_token, authorize("super_admin", "section_admin"), section_id_validator, HandleValidationError, delete_cards)